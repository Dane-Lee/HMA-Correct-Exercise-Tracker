...
const scope = new Function("getAllExercises", `${prelude}\n${html.slice(start, end)}\nreturn { buildPlanPayload };`);
...
const { buildPlanPayload } = scope(() => LIB);
...
assert.throws(() => buildPlanPayload(record({ plan: "No" })), /receives programs only/i);
assert.throws(
